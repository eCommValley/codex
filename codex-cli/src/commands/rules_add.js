...
export const rulesAddCommand = {
  ...
  usage: "codex rules add --account <code> [--counterparty <text>] [--description <text>] [--vat-rate <id>] [--memo <text>]",
  options: [
  ...
  examples: [
    "codex rules add --account 4000 --counterparty NS --vat-rate LOW --memo 'Train travel'",
  ],
  async run({ cwd, options }) {
    ...
    console.log(`Rule ${rule.id} saved. It will apply to future 'codex book' runs.`);
  },
};
